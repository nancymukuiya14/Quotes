...
export class SampleQuotesComponent implements OnInit {
  ...
  quotes: Lovequotes[]= [
    ...
    new Lovequotes(3, 'If i were a moon, i would want you to by my night',  '~Alexandra Vasiliu',new Date('2021,8,21'),0,0),
    new Lovequotes(4, 
      'There is nothing prettier in the whole wide world like a girl in love with every breath she takes','~Cate',new Date('2021,8,21'),0,0)
